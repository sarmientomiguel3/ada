...
public class MatrixGenerator{
	public static void main(String[]args){
		...
		if(arraysize%2!=0||arraysize==0){
			System.err.println("Usage: $java MatrixGenerator <matrix 2potn size and !=0> <repetitionsdefault is 1>");
			System.exit(1);
		}
		//numero de repiticiones
		int repetitions = args.length==1?1:Integer.parseInt(args[1]);
		repetitions=2*repetitions;
		System.out.println(arraysize+" "+arraysize+" "+repetitions);
		for(int i=0;i<repetitions*arraysize;i++){
